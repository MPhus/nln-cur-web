...
import { Dialog, DialogActions, DialogContent, DialogTitle, FormControl, Card as MuiCard } from '@mui/material'
	...
	return (
		<Box sx={{
			...
			<Box sx={{ display: 'flex', flexDirection: 'column', flex: ' 0 0 70%' }} >
				<Box sx={{ minHeight: SEARCH_HEIGHT, padding: '20px 12px', backgroundColor: '#4f6f52', }}>
					<Box sx={{
						position: 'relative',
						'& iframe': {
							width: 0,
